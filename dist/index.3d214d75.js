...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    form.addEventListener('submit', (event)=>{
        ...
        if (isAddressValid) showTippy(button, "Registered!");
        else showTippy(addressInput, "\u274C Invalid BSC address. Please check again.");
    });
    function showTippy(element, message) {
        const instance = (0, _tippyJsDefault.default)(element, {
            content: message,
            trigger: 'manual',
            duration: [
                300,
...
function updateCopyrightYear() {
    ...
    footerTextElements.forEach((element)=>{
        element.textContent = `Binance\xa9 ${currentYear}`;
    });
}
document.addEventListener('DOMContentLoaded', updateCopyrightYear);

},{"tippy.js":"ccpCS","tippy.js/dist/tippy.css":"2hEyg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ccpCS":[function(require,module,exports,__globalThis) {
/**!
* tippy.js v6.3.7
* (c) 2017-2021 atomiks
* MIT License
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","./modifiers/offset.js":"3GKVY","./modifiers/flip.js":"fv5wq","./modifiers/preventOverflow.js":"1AMhb","./modifiers/arrow.js":"31HFW","./modifiers/hide.js":"2g4OF","./popper-lite.js":false,"./modifiers/index.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2hEyg":[function() {},{}]},["dIizP","bB7Pu"], "bB7Pu", "parcelRequire94c2")
